						...
						<table style="width:600px;height:70px;vertical-align:top;margin:0px;padding:0px">
							...
							<tr>
									...
									<tr >
										<td>
											<%
												if((Integer.parseInt(ReportsToAdmin.get(i+6))>=-10) &&(Integer.parseInt(ReportsToAdmin.get(i+6))<=10))
												{
													%>
														previous point&gt;&gt; <%=ReportsToAdmin.get(i+6) %>
													<%
												}
											%>
