...
<div id="tabs" style="margin-left:30px">
  ...
  String opt_search=request.getParameter("opt_ser");
  
  ArrayList <String> ReportsToAdmin=null;

	int option_ser=Integer.parseInt(opt_search);
	...
	if(option_ser==0)
	{
		...
		ReportsToAdmin=new ReportManage().searchViewReportsNotVerified(sdate, edate, pid, uid, opt_search);
	...
	if(option_ser==1)
	{
		...
		ReportsToAdmin=new ReportManage().searchViewReportsNotVerified(sdate, edate, pid, uid, opt_search);
		//ReportsToAdmin=new ReportManage().viewReportsNotVerified();
		 //allreports=new  ReportManage().getAllSerchedReport(sdate, edate, pid, uid, opt);
