...
<table id="tableindex1" width="100%" class="roundborder">
<tr>
	<td>
		<table id="tableadmintop" width="100%" class="roundborder">
			<tr>
				...
				<td>
					<span class="textheader"> Assigned Activity #</span><span class="textheader1"> ${uactivity}</span>
	...
	<td>
		<table width="100%" id="tableadminmid" border="1px solid #560739">
			<tr>
				<td  id="adminleftdiv" valign="top" class="roundborder">
					...
					<ul id="menu">
								  ...
								  <li><a href="#" >Project Main</a>
								  		<ul>
								  		<li><a href="#" onclick="return loadViewProjectsUser();">View Projects</a></li>
							          	<li><a href="#" onclick="return messageInboxUser();">Messages</a></li>
							        </ul>
								  ...
								  <li><a href="#" >Report Main</a>
								  		<ul>
								  		<li><a href="#" onclick="return writeReportUser();">Write Report(Self)</a></li>
								  		<%
				...
				<td  id="usermiddlediv" valign="top" class="roundborder">
...
<tr>
	<td>
		<table width="100%">
			<tr>
				<td>
					<div id="div1111">&copy;www.morphustechnology.com all rights reserved,cont#9439493434</div>				</td>
			</tr>
		</table>
	</td>
</tr>
